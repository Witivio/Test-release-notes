...
The dashboards include [**the performance report**](/documentation/apps/virtual-agent-studio/chatbot/Dashboards/Performance.html) as well as
[**the usage report**](/documentation/apps/virtual-agent-studio/chatbot/Dashboards/Usage.html).
