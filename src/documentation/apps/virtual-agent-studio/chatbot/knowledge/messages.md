...
In case a chatbot has different [**profiles**](/documentation/apps/virtual-agent-studio/chatbot/profile), you have to configure the messages for each profile.
...
This message is displayed when the score is low [**(Low score)**](/documentation/apps/virtual-agent-studio/chatbot/inbox/low_score.html). The
