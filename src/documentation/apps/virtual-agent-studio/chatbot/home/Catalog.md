...
This catalog application lists all the chatbots available in Microsoft Teams, the chatbots you chose to "**publish**" on the application  ([Publish a chatbot in Teams](/documentation/apps/virtual-agent-studio/chatbot/settings/channels.html#microsoft-teams).
