...
This feature is not automatically activated. However, you can decide to activate and configure it in the Tools menu [**(Feedback)**](/documentation/virtual-agent-studio/chatbot/tools/feedback.html).
