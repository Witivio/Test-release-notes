...
<div class="image_center">
  <img :src="$withBase('/assets/img/virtual-agent-studio/metabot/demandedecontextualisation1.PNG')" alt="Metabot">
</div>
...
Click [here](/documentation/virtual-agent-studio/chatbot/communication/campaign.html#teams-campaigns) to know how to configure a Push Teams campaign.  
