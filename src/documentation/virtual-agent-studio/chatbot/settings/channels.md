...
Click [**here**](/documentation/virtual-agent-studio/chatbot/build_your_chatbot/requisites.html) to know how to activate a chatbot on Microsoft Teams.
...
#### [Configuration of the Webchat V1 component compatible with IE11 (obsolete)](/documentation/virtual-agent-studio/chatbot/webchat_v1.html)
