...
The dashboards include [**the performance report**](/documentation/virtual-agent-studio/chatbot/Dashboards/Performance.html) as well as
[**the usage report**](/documentation/virtual-agent-studio/chatbot/Dashboards/Usage.html).
